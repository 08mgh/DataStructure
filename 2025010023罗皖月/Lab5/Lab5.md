...
| :--- | :--- | :--- | :--- |
| 当前 `data` 地址（图 C 为 `v.data`） | （待填：CLion 中查看后填写实际十六进制地址） | （待填：CLion 中查看后填写实际十六进制地址） | （待填：CLion 中查看后填写实际十六进制地址） |
| `newData` 地址 | 尚未申请，不填写 | （待填：CLion 中查看后填写实际十六进制地址） | 已离开作用域，不填写 |
| 当前对象的 `size` | 4 | 4 | 5 |
